...
import com.vincent.micalendar.R;
...
public class CalendarView extends View {
    ...
    private void init(Context context) {
        ...
        mCirclePaint.setColor(getResources().getColor(R.color.data_circle));    // 圆形
        mMarkCirclePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mMarkCirclePaint.setStyle(Paint.Style.FILL);
        mMarkCirclePaint.setColor(getResources().getColor(R.color.data_mark));
    ...
    class Cell {
        ...
        //todo 绘制一个单元格 如果颜色需要自定义可以修改  -- 抽取为自定义属性
        public void drawSelf(Canvas canvas) {
            switch (state) {
                case CURRENT_MONTH_DAY:
                    mTextPaint.setColor(getResources().getColor(R.color.data_current_month_day));
                    break;
                case NEXT_MONTH_DAY:
                case PAST_MONTH_DAY:
                    mTextPaint.setColor(getResources().getColor(R.color.data_other_month_day));
                    break;
                case TODAY:
            ...
            mLunarTextPaint.setColor(getResources().getColor(R.color.data_other_month_day));
            // 绘制文字
